...
namespace Sizzle\Helper\Xml;

/**
 * This class recognizing @attributes and will format accordingly.
 * 
 * @category    Sizzle
 * @package     Helper
 * @subpackage  Xml
...
class ArrayToXml {
    ...
    private static function &convert($node_name, $arr=array()) {
            ...
            if(isset($arr['@attributes'])) {
                foreach($arr['@attributes'] as $key => $value) {
                    if(!self::isValidTagName($key)) {
                        throw new \Exception('[Xml_ArrayToXml] Illegal character in attribute name. attribute: '.$key.' in node: '.$node_name);
                    }
        ...
        if(is_array($arr)){
            ...
            foreach($arr as $key=>$value){
                if(!self::isValidTagName($key)) {
                    throw new \Exception('[Xml_ArrayToXml] Illegal character in tag name. tag: '.$key.' in node: '.$node_name);
                }
     ...
     * @return \Sizzle\Helper\Xml\DomDocument
     */
